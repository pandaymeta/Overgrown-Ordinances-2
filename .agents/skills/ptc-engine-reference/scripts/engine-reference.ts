 ...
 *
 * Usage:
 *   pnpm exec tsx .agents/skills/ptc-engine-reference/scripts/engine-reference.ts <ClassName> [ClassName2 ...]
 *
 * Example:
 *   pnpm exec tsx .agents/skills/ptc-engine-reference/scripts/engine-reference.ts PointLightNode CharacterMovementNode
 */
